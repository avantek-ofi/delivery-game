...
export const loadGame = (): GameState | null => {
  try {
    ...
    return {
      ...
      baseZoneId: saved.baseZoneId ?? 'caballito',
      brand: saved.brand ?? { logo: 'R', primary: '#d85a50', accent: '#f3c667', baseStyle: 'clasica', vehicleStyle: 'clasico', outfitStyle: 'repartidor', packageStyle: 'kraft' },
      ...
      lastRentAt: saved.lastRentAt ?? saved.gameMinutes ?? 0,
